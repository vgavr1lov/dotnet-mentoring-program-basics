...
namespace DBHandlerLibrary {
    ...
    public partial class DataSetOrder : global::System.Data.DataSet {
        ...
        public partial class OrderDataTable : global::System.Data.TypedTableBase<OrderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public OrderRow AddOrderRow(string Status, System.DateTime CreateDate, System.DateTime UpdateDate, int ProductId) {
...
namespace DBHandlerLibrary.DataSetOrderTableAdapters {
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Order] WHERE (([Id] = @Original_Id) AND ([Status] = @Original_" +
                "Status) AND ([CreateDate] = @Original_CreateDate) AND ([UpdateDate] = @Original_" +
                "UpdateDate) AND ([ProductId] = @Original_ProductId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order] ([Status], [CreateDate], [UpdateDate], [ProductId]) VAL" +
                "UES (@Status, @CreateDate, @UpdateDate, @ProductId);\r\nSELECT Id, Status, CreateD" +
                "ate, UpdateDate, ProductId FROM [Order] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Order] SET [Status] = @Status, [CreateDate] = @CreateDate, [UpdateDate] = @UpdateDate, [ProductId] = @ProductId WHERE (([Id] = @Original_Id) AND ([Status] = @Original_Status) AND ([CreateDate] = @Original_CreateDate) AND ([UpdateDate] = @Original_UpdateDate) AND ([ProductId] = @Original_ProductId));
SELECT Id, Status, CreateDate, UpdateDate, ProductId FROM [Order] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=ADODotNetFundamentalsDb;Integr" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Status, CreateDate, UpdateDate, ProductId FROM dbo.[Order]";
        ...
        public virtual int Fill(DataSetOrder.OrderDataTable dataTable) {
        ...
        public virtual DataSetOrder.OrderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int Delete(int Original_Id, string Original_Status, System.DateTime Original_CreateDate, System.DateTime Original_UpdateDate, int Original_ProductId) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((System.DateTime)(Original_UpdateDate));
        ...
        public virtual int Insert(string Status, System.DateTime CreateDate, System.DateTime UpdateDate, int ProductId) {
            if ((Status == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((System.DateTime)(UpdateDate));
        ...
        public virtual int Update(string Status, System.DateTime CreateDate, System.DateTime UpdateDate, int ProductId, int Original_Id, string Original_Status, System.DateTime Original_CreateDate, System.DateTime Original_UpdateDate, int Original_ProductId, int Id) {
            if ((Status == null)) {
                throw new global::System.ArgumentNullException("Status");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((System.DateTime)(UpdateDate));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(Original_UpdateDate));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Status, System.DateTime CreateDate, System.DateTime UpdateDate, int ProductId, int Original_Id, string Original_Status, System.DateTime Original_CreateDate, System.DateTime Original_UpdateDate, int Original_ProductId) {
